...
\captionsetup[subfigure]{labelformat=empty}
  ...
  The ollie phases are (A)`Preparation': athlete lowers their \gls{com} prepares muscles for upward acceleration. (B) `Pre-pop': skateboard
...
planar riding model
\cite{hubbard_lateral_1979,hubbard_human_1980,kremnev_nonlinear_2010,ispolov_skateboard_1996,rosatello_skateboard_2015,varszegi_stability_2017,varszegi_stabilizing_2016,varszegi_downhill_2016,varszegi_balancing_2014,kuleshov_mathematical_2007,kuleshov_various_2010}, which shows the relation between the dimensions and the stability while rolling
