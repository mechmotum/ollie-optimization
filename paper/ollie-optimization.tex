...
\captionsetup[subfigure]{labelformat=empty}
 ...
 \caption[Ollie motion cues]{
    ...
    red line are trajectory of back wheel, middle and front wheel respectively. Images are retrieved from \url{www.youtube.com/watch?v=339k4XEvbxY} with consent.
    \footnotesize
    \begin{center}
