...
\author[1,2]{\fnm{Samuel G.} \sur{Brockie}}\email{s.g.brockie@tudelft.com}
...
\abstract{
  ...
  \cite{hubbard_clearing_1985,varszegi_stabilizing_2016}. The sport also
...
We make use of PyCollo~\cite{brockie_predictive_nodate} to transcribe the
...
After transcription the problem is passed to IPOPT~\cite{ipopt}, an Interior
...
variables \cite{brockie_predictive_nodate} of a phase. In case the transition
from upward to downward motion defines the highest ollie.

% TODO : If the parameters can't influence the objective, then how can you
% possible find a maximum as a function of the parameters? I'm guessing you
% aren't actually doing what you write here. -- JKM
