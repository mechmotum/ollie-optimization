...
% siunitx settings
\sisetup{range-units=single}  % required by sports engineering editor
...
\begin{figure}
    \centering{{\includegraphics[width=0.4\textwidth]{figure/Fig4b.png} }}%
...
We also implement a minimum and maximum foot-to-foot separation of \SIrange{0.1}{1.0}{\meter}, respectively, along with constraining the skater to always stay on top of the skateboard to eliminate relative errors.
